...
import com.turbomandelbrot.ui.ExploreActivity;
...
public class TouchExplorer implements Explorer {
    ...
    private float fps = ExploreActivity.FPS_CAP;
     ...
     */
    private int antiflickering_mode = 0;
    /**
     ...
     */
    private float antiflickering_new_pixel_weight = 0;
    /**
    ...
    public TouchExplorer(ScreenMatrix mat){
        ...
        if(showFPS)
            fpsShowTimesList = new ArrayList((int)Math.ceil(FPS_SHOW_LATENCY / ExploreActivity.MINIMAL_DELTA_TIME));
