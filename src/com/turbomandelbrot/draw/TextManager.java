...
public class TextManager {
	...
	private static final float RI_TEXT_WIDTH = 25.0f;
	private static final float RI_TEXT_SPACESIZE = 15.0f;
	...
	public TextManager(ShaderLoader sh)
	{
		shaderLoader = sh;
	...
	public void Draw(float[] m)
	{
		...
		GLES20.glUseProgram(shaderLoader.sp_Text);
		...
		// initialize byte buffer for the app.draw list
	    ...
	    int mPositionHandle = GLES20.glGetAttribLocation(shaderLoader.sp_Text, "vPosition");
	    ...
	    int mTexCoordLoc = GLES20.glGetAttribLocation(shaderLoader.sp_Text, "a_texCoord" );
        ...
        int mColorHandle = GLES20.glGetAttribLocation(shaderLoader.sp_Text, "a_Color");
        ...
        int mtrxhandle = GLES20.glGetUniformLocation(shaderLoader.sp_Text, "uMVPMatrix");
        
    	// Apply the projection and view transformation
        GLES20.glUniformMatrix4fv(mtrxhandle, 1, false, m, 0);
        
        int mSamplerLoc = GLES20.glGetUniformLocation (shaderLoader.sp_Text, "s_texture" );
